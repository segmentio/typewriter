...
export async function init(args: Arguments, cfg: Config | undefined, buildClient = true) {
...
async function generateClients(
	...
	// If an after script is supplied in the typewriter config, then run it.
	if (cfg.scripts && cfg.scripts.after) {
		await exec(cfg.scripts.after).catch(err => {
