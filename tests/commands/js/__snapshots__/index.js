export function TerribleEventName3(props, context) {
  ...
  if (context) {
    window.analytics.track("42_--terrible==event++name~!3", payload, {
      context
    });
  } else {
    window.analytics.track("42_--terrible==event++name~!3", payload);
...
export function emptyEvent(props, context) {
  if (process.env.NODE_ENV !== "production") {
    const validate = function(
      data,
      dataPath,
  ...
  if (context) {
    window.analytics.track("Empty Event", payload, { context });
  } else {
    window.analytics.track("Empty Event", payload);
  }
}

export function exampleEvent(props, context) {
  if (process.env.NODE_ENV !== "production") {
    const validate = function(
      data,
      dataPath,
      ...
      if (data && typeof data === "object" && !Array.isArray(data)) {
              ...
              if (data2 && typeof data2 === "object" && !Array.isArray(data2)) {
                ...
                if (data2["required sub-property"] === undefined) {
                  ...
                  var err = {
                    ...
                    schemaPath: "#/properties/optional%20array/items/required",
                ...
                var err = {
                  keyword: "type",
                  dataPath: (dataPath || "") + "['optional array'][" + i1 + "]",
          ...
          if (data1 && typeof data1 === "object" && !Array.isArray(data1)) {
            ...
            if (data1["required sub-property"] === undefined) {
              ...
              var err = {
                ...
                params: { missingProperty: "required sub-property" },
                message: "should have required property 'required sub-property'"
              };
              if (vErrors === null) vErrors = [err];
              else vErrors.push(err);
              errors++;
          ...
          if (typeof data1 === "string") {
            if (!pattern0.test(data1)) {
              var err = {
                ...
                schemaPath: "#/properties/optional%20string%20regex/pattern",
              ...
              if (data2 && typeof data2 === "object" && !Array.isArray(data2)) {
                ...
                if (data2["required sub-property"] === undefined) {
                  ...
                  var err = {
                    ...
                    schemaPath: "#/properties/required%20array/items/required",
                    params: { missingProperty: "required sub-property" },
                    message:
                      "should have required property 'required sub-property'"
                  };
                ...
                var err = {
                  keyword: "type",
                  dataPath: (dataPath || "") + "['required array'][" + i1 + "]",
        ...
        if (data["required array (empty)"] === undefined) {
          ...
          var err = {
            ...
            message: "should have required property 'required array (empty)'"
          };
          if (vErrors === null) vErrors = [err];
          else vErrors.push(err);
          errors++;
        ...
        if (data1 === undefined) {
          ...
          var err = {
            ...
            message: "should have required property 'required object (empty)'"
          };
          if (vErrors === null) vErrors = [err];
          else vErrors.push(err);
          errors++;
          ...
          if (typeof data1 === "string") {
            if (!pattern0.test(data1)) {
              var err = {
                ...
                schemaPath: "#/properties/required%20string%20regex/pattern",
                params: { pattern: "FOO|BAR" },
                message: 'should match pattern "FOO|BAR"'
              };
              if (vErrors === null) vErrors = [err];
  ...
  if (context) {
    window.analytics.track("Example Event", payload, { context });
  } else {
    window.analytics.track("Example Event", payload);
  }
}
