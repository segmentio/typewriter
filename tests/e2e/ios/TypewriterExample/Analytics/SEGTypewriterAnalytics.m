...
{
    [SEGTypewriterAnalytics everyNullableOptionalTypeWithOptionalNumber:optionalNumber optionalObject:optionalObject optionalString:optionalString optionalStringWithRegex:optionalStringWithRegex optionalAny:optionalAny optionalArray:optionalArray optionalBoolean:optionalBoolean optionalInt:optionalInt options:@{}];
}
...
{
    [SEGTypewriterAnalytics everyNullableRequiredTypeWithRequiredArray:requiredArray requiredBoolean:requiredBoolean requiredInt:requiredInt requiredNumber:requiredNumber requiredObject:requiredObject requiredString:requiredString requiredStringWithRegex:requiredStringWithRegex requiredAny:requiredAny options:@{}];
}
...
requiredAny:(nullable id)requiredAny
{
    [SEGTypewriterAnalytics everyRequiredTypeWithRequiredArray:requiredArray requiredBoolean:requiredBoolean requiredInt:requiredInt requiredNumber:requiredNumber requiredObject:requiredObject requiredString:requiredString requiredStringWithRegex:requiredStringWithRegex requiredAny:requiredAny options:@{}];
}
...
options:(nullable SERIALIZABLE_DICT)options
{
    ...
    if (propertyCollided != nil) {
      properties[@"property_collided"] = propertyCollided;
    }
    if (propertyCollided1 != nil) {
      properties[@"Property Collided"] = propertyCollided1;
    }
