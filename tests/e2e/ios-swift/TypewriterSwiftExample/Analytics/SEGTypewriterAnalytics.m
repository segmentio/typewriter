...
+ (void)everyNullableOptionalTypeWithOptionalStringWithRegex:(nullable NSString *)optionalStringWithRegex
...
+ (void)simpleArrayTypesWithString:(nullable NSArray<NSString *> *)string
...
{
    [SEGTypewriterAnalytics simpleArrayTypesWithString:string any:any boolean:boolean integer:integer nullable_:nullable_ number:number object:object options:@{}];
}
