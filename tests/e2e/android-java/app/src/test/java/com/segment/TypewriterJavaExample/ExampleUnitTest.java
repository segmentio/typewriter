...
public class ExampleUnitTest {
  ...
  public void exampleTests() {
    ...
    TypewriterAnalytics.with(ctx).emptyEvent();
    ...
    TypewriterAnalytics.with(ctx).everyRequiredType(everyRequiredType);
    ...
    TypewriterAnalytics.with(ctx).everyOptionalType(new EveryOptionalType.Builder().build());
    TypewriterAnalytics.with(ctx).everyOptionalType(everyOptionalType);
    ...
    TypewriterAnalytics.with(ctx).everyNullableRequiredType(everyNullableRequiredType);
    ...
    TypewriterAnalytics.with(ctx).everyNullableRequiredType(everyNullableRequiredTypeNull);

    TypewriterAnalytics.with(ctx).everyNullableOptionalType(new EveryNullableOptionalType.Builder().build());
    ...
    TypewriterAnalytics.with(ctx).everyNullableOptionalType(everyNullableOptionalType);
    ...
    TypewriterAnalytics.with(ctx).everyNullableOptionalType(everyNullableOptionalTypeComplete);

    TypewriterAnalytics.with(ctx).I42TerribleEventName3();

    PropertySanitized propertySanitized = new PropertySanitized.Builder()
            .I0000TerriblePropertyName3("what a cronenberg")
            .build();

    TypewriterAnalytics.with(ctx).propertySanitized(propertySanitized);

    TypewriterAnalytics.with(ctx).eventCollided();
    TypewriterAnalytics.with(ctx).eventCollided1();
    ...
    TypewriterAnalytics.with(ctx).propertiesCollided(propertiesCollided);
    ...
    TypewriterAnalytics.with(ctx).propertyObjectNameCollision1(propertyObjectNameCollision1);
    ...
    TypewriterAnalytics.with(ctx).propertyObjectNameCollision2(propertyObjectNameCollision2);
    ...
    TypewriterAnalytics.with(ctx).simpleArrayTypes(simpleArrayTypes);
    ...
    TypewriterAnalytics.with(ctx).nestedObjects(nestedObjectsWithGarage);
    ...
    TypewriterAnalytics.with(ctx).nestedArrays(nestedArrays);
    ...
    TypewriterAnalytics.with(ctx).largeNumbersEvent(largeNumberEvent);
