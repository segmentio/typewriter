...
test-android-runner:
	...
	@cd tests/e2e/android-java && set -o pipefail && ./gradlew test
	@SDK=android-java LANGUAGE=$(LANGUAGE) IS_DEVELOPMENT=$(IS_DEVELOPMENT) yarn run -s jest ./tests/e2e/suite.test.ts
